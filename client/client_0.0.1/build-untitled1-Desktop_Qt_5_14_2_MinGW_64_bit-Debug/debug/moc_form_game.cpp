/****************************************************************************
** Meta object code from reading C++ file 'form_game.h'
**
...
#include <memory>
#include "../../untitled1/form_game.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'form_game.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_form_game_t, stringdata0) + ofs \
...
static const uint qt_meta_data_form_game[] = {
...
QT_INIT_METAOBJECT const QMetaObject form_game::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_form_game.data,
    qt_meta_data_form_game,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *form_game::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *form_game::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_form_game.stringdata0))
