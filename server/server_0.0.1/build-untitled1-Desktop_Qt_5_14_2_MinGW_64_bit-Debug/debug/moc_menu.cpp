...
QT_MOC_LITERAL(1, 5, 17), // "signalstartServer"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Menu\0signalstartServer\0"
};
...
void Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalstartServer(); break;
        default: ;
        }
        ...
        {
            using _t = void (Menu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Menu::signalstartServer)) {
                *result = 0;
                return;
            }
        }
